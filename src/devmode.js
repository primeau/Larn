...
function enableDevmode() {
    ...
    updateLog(`normal ${START_ITALIC}italic${END_ITALIC} ${START_STRIKE}strike${END_STRIKE} ${START_BOLD}bold${END_BOLD} ${START_DIM}dim${END_DIM} ${highlightText('mark', 'yellow')} ${START_UNDERLINE}underline${END_UNDERLINE} ${linkText('Link', 'https://larn.org')} ${colorText('red', 'red')} ${colorText('green', 'green')} ${colorText('blue', 'blue')}`);
